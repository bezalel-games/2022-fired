...
public class FlockingScript : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        var boids = boidColliders.Select(o => o.GetComponent<FlockingScript>()).ToList();
        boids.Remove(this);
    ...
    private void Flock(IEnumerable<FlockingScript> boids)
    {
    ...
    private Vector2 Alignment(IEnumerable<FlockingScript> boids)
    {
    ...
    private Vector2 Cohesion(IEnumerable<FlockingScript> boids)
    {
    ...
    private Vector2 Separation(IEnumerable<FlockingScript> boids)
    {
    ...
    private float DistanceTo(FlockingScript boid)
    {
